...
import {AcademicCoursePlan} from '../model/exam-management';
...
export class VrEduService {
  ...
  public findCoursePlansByProgram(programCode : string): Observable<AcademicCoursePlan[]> {
    return this.vrHttp.invokeBeanMethod('examManagementPlugin', "findCoursePlansByProgram('"+programCode+"')");
  }
