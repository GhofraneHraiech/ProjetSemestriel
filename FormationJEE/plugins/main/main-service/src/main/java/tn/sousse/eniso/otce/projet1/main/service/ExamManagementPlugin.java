...
import net.vpc.upa.config.PersistenceUnit;
...
public List<AcademicCoursePlan> findCoursePlansByProgram(String programCode){

   UPA.getPersistenceUnit().createQuery("select x from AcademicCoursePlan x ")
}
}
